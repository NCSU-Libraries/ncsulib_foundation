...
<nav id="primary-nav-menus" role="navigation" aria-label="main navigation">
	...
	<div id="menu-help" class="primary-menu-list">
		...
		<ul>
			...
			<li><a href="//www.lib.ncsu.edu/researchconsultation">Research Consultation</a></li>
	...
	<div id="utility-bar">
		...
		<div id="home-hours">
			...
			<ul>
				...
				<li><a href="//www.lib.ncsu.edu/hours/hunt/general"><span class="library">James B. Hunt Jr.:</span> &nbsp; <span class="hours">Closes at midnight<?php echo '';//$ary['hunt']; ?></span></a></li>
			</ul>
		</div>
		<?php else: ?>

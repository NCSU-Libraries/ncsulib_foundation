...
<!-- <link href="http://cdn.ncsu.edu/brand-assets/utility-bar/css/main-red.css" rel="stylesheet" type="text/css" /> -->
<!-- load brand bar in this order to prevent conflict with other js (particularly chat) -->

          ...
          <?php endif; ?>
            <?php foreach ($start_times as $time_cnt => $start_time): ?>
              ...
              <div class="<?php print $class?>calendar-agenda-hour">
                ...
                ?>
                <span class="calendar-hour"><?= $hr; ?></span><span class="calendar-ampm"><?php print $time['ampm']; ?></span>
              </div>
              <?php else: ?>
                  ...
                  <div class="inner">
                    <?php if(!empty($items[$start_time]['values'][$index - 1])) :?>
                      <?php foreach($items[$start_time]['values'][$index - 1] as $item) :?>
                        ...
                        <?php else : ?>
                        <div class="item <?php print $item['class']?><?php echo ' size-'.floor(100/count($items[$start_time]['values'][$index - 1])); ?>">
                        <?php endif; ?>

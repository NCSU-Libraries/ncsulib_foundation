...
<div id="page" class="row">
  <div class="content-border">
    ...
    <?php if ($page['header']): ?>
      <div id="header" class="columns large-12">
        <?php print render($page['header']); ?>
      </div>
    <?php endif; ?>

    <div id="main" class="column columns large-4">
    <!-- <div id="main" class="column <?php //print ns('grid-16', $page['sidebar_first'], 4, $page['sidebar_second'], 4) . ' ' . ns('push-4', !$page['sidebar_first'], 4); ?>"> -->
      <div id="main-content" class="main-content region">
        ...
        <div class="columns large-8"> <a href="/techlending/laptops" class="ignore"><img src="/sites/default/files/techlending/macbook.png" alt="Apple MacBook" class="float-right" /></a>
        ...
        <div class="columns large-8 cleft">
        ...
        <div class="columns large-8">
          ...
          <ul>
            <li>Available for either 4 hour or 7 day loan period</li>
            <li>Available on a first come, first served basis from the main service desk</li>
            <li><a href="/techlending/voicerecorders">More details about these devices<br />
            </a></li>
          </ul>
        </div>
        <div class="columns large-8">
		...
		<?php if ($page['sidebar_first']): ?>
			<div id="sidebar-left" class="column sidebar region large-4 columns <?php //print ns('pull-12', $page['sidebar_second'], 4); ?>">
				<?php print render($page['sidebar_first']); ?>
			</div>
		<?php endif; ?>

		<?php if ($page['sidebar_second']): ?>
			<div id="sidebar-right" class="column sidebar region columns large-4">
				<?php print render($page['sidebar_second']); ?>
			</div>
		<?php endif; ?>

		<?php if ($page['footer']): ?>
			<div id="footer" class="columns large-16">

...
?>
page--techlending.tpl.php
<?php include DRUPAL_ROOT."/".$GLOBALS['theme_path']."/templates/includes/header.php"; ?>
<div id="page" class="container-16">
	<div class="content-border">
        ...
        <div class="grid-8 alpha"> <a href="/techlending/laptops" class="ignore"><img src="/sites/default/files/techlending/macbook.png" alt="Apple MacBook" class="float-right" /></a>
...
<?php include DRUPAL_ROOT."/".$GLOBALS['theme_path']."/templates/includes/footer.php"; ?>

	...
	<div class="content-border">
		...
		<div id="main" class="column grid-16>">
			<div id="main-content" class="main-content region">
				...
				<img alt="Kamphoefner House" src="/sites/default/files/built_environment_house.jpg">
				</div>
				...
				<img alt="Lewis Clarke collage" src="/sites/default/files/built_environment_collage.jpg">
				</div>
			</div>
		</div>

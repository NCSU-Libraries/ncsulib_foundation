	...
	<div class="content-border">
		...
		<div id="main" class="column grid-16>">
			<div id="main-content" class="main-content region">
				...
				<img alt="Lewis Clarke House" src="/sites/default/files/lewis_clarke_house.jpg">
				</div>
				...
				<img alt="Lewis Clarke collage" src="/sites/default/files/lewis_clarke_collage.jpg">
				</div>
			</div>
		</div>
